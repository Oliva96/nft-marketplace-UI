...
// This should render from the backend side
...
const SingleArtWork = ({ fa, darkMode }) => {
  ...
  return (
    ...
    <>
      ...
      <Box className={styles.detailsContainerBox}>
        <Box>
          {/* Top navigation */}
          {!isMobile ? (
            ...
            <Box className={styles.topNavigationBoxMobile}>
              ...
              <Typography
                ...
                alignItems="center"
              >
                <Typography variant="body2" component="p" sx={{ zIndex: 2 }}>
                  {t("ITEM_DETAILS")}
                </Typography>
              </Typography>
            </Box>
              ...
              <Box>
                ...
                <Box>
                  ...
                  {location.pathname === `/auction/${id}` && (
                    ...
                    >
                      <Box>
                        <CountDownBoard futureDate={futureDate} />
                      </Box>
                    </Box>
                  )}
                </Box>
